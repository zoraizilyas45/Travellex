...
const Khunjerab = ({ navigation }) => {
    return (
        ...
        <View style={{ flex: 1, paddingHorizontal: 20, backgroundColor: '#FFFFFF', }}>
            ...
            <ScrollView>
                <View><Image style={{ marginTop: 10, height: 250, width: 330, resizeMode: "stretch", borderTopRightRadius: 40, borderBottomLeftRadius: 40, borderTopLeftRadius: 60, borderBottomRightRadius: 60, marginRight: 30 }} source={require('../Assets/khunjrab.jpg')}
                />
                </View>
                <View style={{ marginTop: 30, }}>
                    <Text style={{ fontSize: 24, textAlign: 'left', color: '#FFA500', fontFamily: 'Roboto', fontStyle: 'normal', fontWeight: 'bold', }} >
                        Khunjerab Pakistan-China Border,Pakistan
                    </Text>
                ...
                <View>
                    <Text style={{ textAlign: 'center', padding: 5, fontSize: 15, color: '#FFA500', marginLeft: -10, marginTop: -7, }} >The Khunjerab Pass is the highest-paved international border crossing in the world and the highest point on the Karakoram Highway.</Text>
                </View>
                <View>
                    <TouchableOpacity
                        ...
                        onPress={() => {
                            navigation.navigate(ScreenNames.ListCity, { item: 'helo' })
                        }} >
